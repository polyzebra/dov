...
export default function Hero() {
  ...
  <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-4 sm:gap-16 sm:px-6 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="relative">
          <div className="group relative mx-auto w-full max-w-full overflow-hidden rounded-4xl border border-black/5 bg-white p-5 shadow-[0_20px_45px_-25px_rgba(15,23,42,0.22),0_10px_18px_-12px_rgba(15,23,42,0.1)] transition-transform duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_26px_55px_-26px_rgba(15,23,42,0.26),0_16px_22px_-14px_rgba(15,23,42,0.13)] sm:mx-0 sm:max-w-95 sm:p-7">
            <div className="relative">
