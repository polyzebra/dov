  ...
  <div className={`mt-10 grid gap-6 sm:mt-14 sm:gap-8 ${gridColumns}`}>
          {items.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="card group relative overflow-hidden border border-slate-200/80 bg-white p-6 shadow-[0_20px_50px_-35px_rgba(15,23,42,0.45)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_34px_80px_-35px_rgba(14,116,144,0.65)] sm:p-8"
              >
