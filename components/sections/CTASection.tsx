  ...
  return (
    <section className="bg-white py-20 animate-fade-in">
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="relative overflow-hidden rounded-4xl border border-sky-100 bg-linear-to-br from-sky-50 via-white to-indigo-50 p-12 shadow-[0_45px_90px_-55px_rgba(14,116,144,0.7)]">
