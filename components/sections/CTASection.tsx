...
export default function CTASection({
  ...
  <div className="relative overflow-hidden rounded-lg border border-slate-200/70 bg-linear-to-br from-sky-50 via-white to-indigo-50 p-8 shadow-[0_24px_60px_-30px_rgba(14,116,144,0.18)] sm:p-10 lg:p-12">
